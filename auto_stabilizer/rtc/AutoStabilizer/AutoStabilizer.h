...
protected:
  ...
  public:
    ...
    RTC::TimedPoint3D m_rarmPoint_;    
    RTC::OutPort<RTC::TimedPoint3D> m_rarmPointOut_;
    RTC::TimedOrientation3D m_rarmOrientation_;
    RTC::OutPort<RTC::TimedOrientation3D> m_rarmOrientationOut_;

    RTC::TimedPoint3D m_larmPoint_;    
    RTC::OutPort<RTC::TimedPoint3D> m_larmPointOut_;
    RTC::TimedOrientation3D m_larmOrientation_;
    RTC::OutPort<RTC::TimedOrientation3D> m_larmOrientationOut_; 
